...
namespace Taum
{
    ...
    internal static class PropIndex
    {
        ...
        /// <summary>
        /// Drop the index. It holds direct references to prefabs, and those are destroyed
        /// and rebuilt with every world - so an index carried across a world change hands
        /// out destroyed objects, which Unity reports as a missing material rather than as
        /// a stale cache.
        /// </summary>
        ...
        private static void BuildIndex()
        {
            ...
            TaumPlugin.Log.LogInfo("Prop index built: " + _index.Count + " candidates with meshes.");
        }

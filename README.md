...
The first design was a crafted halter and a lead - an item, a worn model, rope physics.
It was cut to this on purpose: the thing the mod exists for is walking one animal to its
new pen, and vanilla already contains everything that needs. Wolves and lox follow
through the game's own command system; boars and hens have the same machinery and merely
